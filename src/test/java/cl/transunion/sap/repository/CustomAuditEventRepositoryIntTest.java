...
import cl.transunion.sap.config.audit.AuditEventConverter;
import cl.transunion.sap.domain.PersistentAuditEvent;
...
import static cl.transunion.sap.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
